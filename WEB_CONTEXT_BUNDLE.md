...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-521-erd-s-problem-521-df2dac5c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-521"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-521-erd-s-problem-521-df2dac5c-v1",
      "problem_contract_sha256": "6cfc7137f3b660203749d663eb806fcb4948d596dca4c2566ce6226ed4db99da",
      "problem_id": "problem:um-ep-521-erd-s-problem-521-df2dac5c",
      "route_id": "route:um-ep-521-erd-s-problem-521-df2dac5c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-521-erd-s-problem-521-df2dac5c-source-fidelity-01",
      "graph_id": "graph:um-ep-521-erd-s-problem-521-df2dac5c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-521-erd-s-problem-521-df2dac5c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-521-erd-s-problem-521-df2dac5c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $(\\epsilon_k)_{k\\geq 0}$ be independently uniformly chosen at random from $\\{-1,1\\}$. If $R_n$ counts the number of real roots of $f_n(z)=\\sum_{0\\leq k\\leq n}\\epsilon_k z^k$ then is it true that, almost surely, $ \\lim_{n\\to \\infty}\\frac{R_n}{\\log n}=\\frac{2}{\\pi}? $"
          },
          "statement_sha256": "3bc8e80909f1f8fdb0103875a7443d85a1588736c8c76dffbd18ee860a71b399"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-521-erd-s-problem-521-df2dac5c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-521-erd-s-problem-521-df2dac5c-root",
      "route_id": "route:um-ep-521-erd-s-problem-521-df2dac5c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-521-6f7e59e61369",
        "url": "https://www.unsolvedmath.com/problems/EP-521"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
